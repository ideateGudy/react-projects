          ...
          <div className="flex-1 space-y-6 lg:space-y-7">
            <div className="space-y-4 lg:space-y-5">
              ...
              <div className="flex gap-3 items-center">
                ...
                <p className="uppercase text-xs font-medium tracking-widest text-neutral-500 dark:text-neutral-400">
            ...
            <div className="flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800">
              <div className="flex -space-x-3">
                <img src="https://testingbot.com/free-online-tools/random-avatar/200?2" alt="User Avatar" className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover" />
                <img src="https://testingbot.com/free-online-tools/random-avatar/200?3" alt="User Avatar" className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover" />
                <img src="https://testingbot.com/free-online-tools/random-avatar/200?5" alt="User Avatar" className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover" />
                <span className="flex items-center justify-center w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-neutral-900 dark:bg-amber-500 text-xs font-medium text-white dark:text-neutral-900 border-2 border-white dark:border-neutral-900">
                  +5K
                </span>
              </div>
              ...
              <div className="relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center justify-between mb-3 lg:mb-4">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 lg:h-3 lg:w-3 rounded-full bg-red-500"></span>
                    <span className="w-2.5 h-2.5 lg:h-3 lg:w-3 rounded-full bg-amber-500"></span>
                    <span className="w-2.5 h-2.5 lg:h-3 lg:w-3 rounded-full bg-green-500"></span>
                  </div>
                  <div className="text-xs text-neutral-500 dark:text-neutral-400">{darkMode ? "dark-mode.tsx" : "light-mode.tsx"}</div>
                </div>
                <div className="h-56 md:h-64 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative">
                  <img src="/images/code-light.png" alt="Code snippet for light mode" className="w-full h-full object-cover object-top-left dark:hidden" />
                  <img src="/images/code-dark.png" alt="Code snippet for dark mode" className="w-full h-full object-cover object-top-left hidden dark:block" />
                ...
                <div className="mt-3 lg:mt-4 flex justify-between items-center">
                  ...
                  <button className="w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10 flex items-center justify-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition-colors duration-300">
